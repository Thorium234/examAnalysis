    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('super_user', 'Super User'), ('principal', 'Principal'), ('deputy', 'Deputy Principal'), ('dos', 'Director of Studies'), ('teacher', 'Teacher')], default='teacher', max_length=20)),
