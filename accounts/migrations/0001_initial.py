    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roles', models.ManyToManyField(related_name='profiles', to='accounts.role')),
            ],
        ),
        migrations.CreateModel(
            name='TeacherClass',
            fields=[
                ...
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teacher_classes', to='school.school')),
